  ...
  43                     ; 3 void I2C_GPIO_setup(void)
  43                     ; 4 
  43                     ; 5 {  
  45                     	switch	.text
  46  0000               _I2C_GPIO_setup:
  50                     ; 7     GPIO_Init(I2C_PORT,
  50                     ; 8 
  50                     ; 9               ((GPIO_Pin_TypeDef)(SCL_pin | SDA_pin)),
  50                     ; 10 
  50                     ; 11               GPIO_MODE_OUT_PP_HIGH_FAST);
 ...
 101                     ; 21     I2C_Init(100000,
 101                     ; 22 
 101                     ; 23                   PCF8574_address,
 101                     ; 24 
 101                     ; 25                   I2C_DUTYCYCLE_2,
 101                     ; 26 
 101                     ; 27                   I2C_ACK_CURR,
 101                     ; 28 
 101                     ; 29                   I2C_ADDMODE_7BIT,
 101                     ; 30 
 101                     ; 31                   (CLK_GetClockFreq() / 1000000));
